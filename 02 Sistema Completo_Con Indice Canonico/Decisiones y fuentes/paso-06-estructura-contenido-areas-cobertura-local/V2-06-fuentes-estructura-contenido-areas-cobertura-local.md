...
|---|---|---|---|---|
| 6.01 · Paso-06 §7 Main City | Se decide que Madrid crea la estructura principal | Input humano | El cliente proporciona este dato directamente. El sistema lo recoge sin transformación. Madrid heredado del paso 1.20. | Madrid |
